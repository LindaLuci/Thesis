...
abbiamo cosndierato la prob del caso peggiore, in realta la prob è ancora piu bassa ci sono altre prob sfavorevoli che hanno prob molto piu alta. quindi è difficile che tu riesca a perdere un dato.
