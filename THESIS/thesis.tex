...
\newcommand{\myEnglishTitle}{Implementation and testing of a peer network database cluster\xspace}
...
\emph{"Mi importa una sega della tesi, io sono qui ad acchiappare le cicce" \break --- Inserire autore citazione} \vspace{\stretch{2}}\null
\end{flushright}
\cleardoublepage
\include{firstChapter}
\include{secondChapter}
\include{thirdChapter}
\include{fourthChapter}
